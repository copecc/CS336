...
def get_flashattention_autograd_function_pytorch() -> Type:
    ...
    from cs336_systems.flash_attention.pytorch.flash_attention import FlashAttention
...
def get_flashattention_autograd_function_triton() -> Type:
    ...
    from cs336_systems.flash_attention.triton.flash_attention import FlashAttention
...
def get_ddp_bucketed(module: torch.nn.Module, bucket_size_mb: float) -> torch.nn.Module:
    ...
    Returns:
        Instance of a DDP class.
    """
    from cs336_systems.ddp import DDPBucketedParameters
